...
export class ExperimentDescriptionEditorComponent implements OnInit {
  ...
  @ViewChild(ProsumerEditorComponent, {static: false}) prosumerEditor!: ProsumerEditorComponent;
  @ViewChild(P2pMarketdesignEditorComponent, {static: false}) p2pmdEditor!: P2pMarketdesignEditorComponent;
  ...
  submitExperimentDesign(): void {
    //TODO adjust to new experiment description form and uncomment
    if (this.descriptionForm.errors === null) {
      // this.database.addExperimentDescription({
