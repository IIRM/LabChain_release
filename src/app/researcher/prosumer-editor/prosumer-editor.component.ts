...
export class ProsumerEditorComponent implements OnInit {
  ...
  public selectedProsumer: Prosumer | undefined;
  /** selector variable to refer to the pill selected by the user */
  public selectedPill = 'Loads';
